    ...
    <div class="relative -top-32 sm:-top-44">
        ...
        <div class="bg-white rounded-lg p-8 mt-4 shadow-md h-96">
            ...
            <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 mt-4">
                <a href="{{ route('tasks.report', ['date' => Morilog\Jalali\Jalalian::now()->subDays()->format('Y-m-d')]) }}" class="flex items-center bg-white hover:shadow-md transition border border-gray-200 p-4 rounded-md text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('tasks.report') }}" class="flex items-center bg-white hover:shadow-md transition border border-gray-200 p-4 rounded-md text-blue-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('calendar.daily') }}" class="flex items-center bg-white hover:shadow-md transition border border-gray-200 p-4 rounded-md text-purple-800">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 mt-4">
                <a href="{{ route('users.edit', auth()->id()) }}" class="flex items-center bg-white hover:shadow-md transition border border-gray-200 p-4 rounded-md text-purple-800">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span class="text-sm relative top-0.5 mr-2 variable-font-medium">@lang('تغییر کلمه عبور')</span>
                </a>
            </div>
        </div>
    </div>
